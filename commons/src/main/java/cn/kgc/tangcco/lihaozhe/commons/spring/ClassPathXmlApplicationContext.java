package cn.kgc.tangcco.lihaozhe.commons.spring;
...
import cn.kgc.tangcco.lihaozhe.commons.factory.MultipleBeanFactory;
import cn.kgc.tangcco.lihaozhe.commons.factory.SingleBeanFactory;
import cn.kgc.tangcco.lihaozhe.commons.xml.BaseXML;

public class ClassPathXmlApplicationContext extends BaseXML {
	/**
	 * 默认配置文件
	 */
	private static final String applicationContextConfig = "ApplicationContext_on.xml";
	/**
	 * 自定义配置文件类路径位置
	 */
