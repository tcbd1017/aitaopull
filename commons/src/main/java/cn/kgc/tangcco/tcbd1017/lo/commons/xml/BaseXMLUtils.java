package cn.kgc.tangcco.tcbd1017.lo.commons.xml;
/**
 * 
 * @author 李昊哲
 * @version 1.0 <br>
 * 创建时间:	2019年9月25日	上午9:04:53<br>
 * 类描述:
 *
 */
...
public abstract class BaseXMLUtils {
	/**
	...
	public static InputStream getInputStream(String config) {
		return BaseXMLUtils.class.getClassLoader().getResourceAsStream(config);
	}
