package cn.kgc.tangcco.tcbd1017.lo.commons.spring;
...
import cn.kgc.tangcco.tcbd1017.lo.commons.factory.MultipleFactory;
import cn.kgc.tangcco.tcbd1017.lo.commons.factory.SigletonFactory;
import cn.kgc.tangcco.tcbd1017.lo.commons.xml.BaseXMLUtils;
 ...
 * @author 李昊哲
 * @version 1.0 <br>
 * 创建时间:	2019年9月25日	上午9:19:32<br>
 * 类描述:	
 *
 */
public class ClassPathXmlApplicationContext extends BaseXMLUtils{
	/**
	 * 默认配置文件
	 */
	...
	public Object getBean(String beanId) throws Exception {
		...
		if (multiple) {
			return MultipleFactory.getInstance(beanClass);
		}
		return SigletonFactory.getInstance(beanId, beanClass);
	}
	/**
	 * 读取配置文件信息
	 * 
